...
export const metadata: Metadata = {
  title: "BVB Fan Shop - Official Borussia Dortmund Merchandise",
  description: "Shop authentic BVB merchandise from the official Borussia Dortmund fan store. Jerseys, scarves, accessories and more for true supporters worldwide.",
  keywords: "BVB, Borussia Dortmund, football merchandise, jerseys, fan shop, official store",
  metadataBase: new URL("https://bvbfanshop.com"),
  alternates: {
    canonical: "https://bvbfanshop.com"
  },
  openGraph: {
    title: "BVB Fan Shop - Official Borussia Dortmund Merchandise",
    description: "Shop authentic BVB merchandise from the official fan store",
    siteName: "BVB Fan Shop",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763736643053-yj8evked.jpg",
      alt: "BVB stadium and merchandise"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "BVB Fan Shop - Official Merchandise",
    description: "Authentic Borussia Dortmund gear for true supporters",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763736643053-yj8evked.jpg"]
  },
  robots: {
    index: true,
    follow: true
